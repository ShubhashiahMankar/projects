...
public class Download extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String filePath = "D:\\eclipse-jee-2019-06-R-win32-x86_64\\JavaEEProjects\\internshiptestproject\\uploadedfiles\\"+fnm;
		...
		con=db.getDcon();
		String uid;
		pst1=con.prepareStatement("select userid,ftype from uploads where fnm=?;");
